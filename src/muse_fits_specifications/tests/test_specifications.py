...
class PackagedSpecTest(unittest.TestCase):
    def test_both_levels_load_and_are_substantial(self):
    ...
    def test_mission_identity_keywords(self):
    ...
    def test_structural_cards_are_not_required(self):
        for name in ("XTENSION", "ZCMPTYPE", "CHECKSUM", "BZERO"):
    ...
    def test_bad_keyword_definitions_are_rejected(self):
    ...
    def test_keywords_carry_their_section(self):
...
class ValidationTest(unittest.TestCase):
    ...
    def test_values_and_format_checks(self):
        spec = _spec(
    ...
    def test_untyped_keyword_only_checks_presence(self):
        spec = _spec(FREE=KeywordSpec("FREE", required=True))
        assert validate({"FREE": object()}, spec) == []

    def test_ensure_valid_raises_with_error_list(self):
    ...
    def test_empty_header_reports_every_required_keyword(self):
...
class RenderTest(unittest.TestCase):
    def test_render_contains_keywords_and_escapes_markup(self):
